...
procedure TfrRevisor.btnExportarGridClick(Sender: TObject);
var i: integer ;
begin
      ...
      Begin
        ...
        Begin
          if StringGrid1.ColCount = 4 then
             Add(Format('%s|----|%s|----|%s', [StringGrid1.Cells[1, i], StringGrid1.Cells[2, i], StringGrid1.Cells[3, i]]))
          else
             Add(Format('%s|----|%s', [StringGrid1.Cells[1, i], StringGrid1.Cells[2, i]])) ;
          Add('') ;
        End;

        // Salva o arquivo
        if(rdCargaArquivos.Checked) then
           SaveToFile(ExtractFilePath(edIngles.Text)+'..\exportacao.txt', TEncoding.UTF8 )
        else
           SaveToFile(ExtractFilePath(edPastaIngles.Text)+'..\exportacao.txt', TEncoding.UTF8 );
...
Begin
      ...
      begin
           ...
           Cols[0].Assign(StringsLinhas);
           Cols[2].Assign(StringsTraduzido);
        if ColCount = 4 then
           Cols[3].Assign(StringsEspanhol);
